...
import com.amazon.opendistroforelasticsearch.alerting.aggregation.BucketSelectorExtFilter.Companion.BUCKET_SELECTOR_COMPOSITE_AGG_FILTER
import com.amazon.opendistroforelasticsearch.alerting.aggregation.BucketSelectorExtFilter.Companion.BUCKET_SELECTOR_FILTER
    ...
    AbstractPipelineAggregationBuilder<BucketSelectorExtAggregationBuilder>
{
    ...
    private constructor(name: String?,
                ...
                filter: BucketSelectorExtFilter?) : super(name, NAME.preferredName, listOf<String>(parentBucketPath).toTypedArray<String>()) {
