...
package com.amazon.opendistroforelasticsearch.alerting.aggregation

import com.amazon.opendistroforelasticsearch.alerting.aggregation.BucketSelectorExtAggregationBuilder.Companion.NAME
...
class BucketSelectorExtAggregator : SiblingPipelineAggregator {
    ...
    constructor(name: String?,bucketsPathsMap: Map<String, String>, parentBucketPath: String,
                script: Script,gapPolicy: GapPolicy, filter: BucketSelectorExtFilter?,
                metadata: Map<String, Any>?) : super (name, bucketsPathsMap.values.toTypedArray(), metadata) {
    ...
    override fun doReduce(aggregations: Aggregations, reduceContext: ReduceContext): InternalAggregation {
        ...
        val aggregation = aggregations.get<Aggregation>(parentBucketPathList[0])
        val originalAgg =
            aggregation as InternalMultiBucketAggregation<*, *>
